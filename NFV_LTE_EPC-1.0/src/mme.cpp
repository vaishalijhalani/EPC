...
string g_trafmon_ip_addr = "192.168.122.1";
string g_mme_ip_addr = "192.168.122.1";
string g_hss_ip_addr = "192.168.122.35";
string g_sgw_s11_ip_addr = "192.168.122.35";
string g_sgw_s1_ip_addr = "192.168.122.35";
string g_sgw_s5_ip_addr = "192.168.122.35";
string g_pgw_s5_ip_addr = "192.168.122.35";
...
string t_ran_ip_addr = "192.168.122.35";
int t_ran_port = 4905;

string s_ran_ip_addr = "192.168.122.35";
int s_ran_port = 4905;
...
void Mme::request_target_RAN( Packet pkt) {
	...
	cout<<"send to target ran done from mme"<<endl;
